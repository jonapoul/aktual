...
// Reports a compile error for @IdType classes whose wrapped value type isn't Comparable, since
...
internal object IdComparableChecker : FirClassChecker(Common) {
  ...
  override fun check(declaration: FirClass) {
    ...
    reporter.reportOn(
      ...
      a =
        "@IdType class '${declaration.name}' wraps a type that isn't Comparable, so toString()/compareTo() can't be generated",
    )
  }
}
