...
@Composable
private fun InfoButtonsColumn(onAction: (InfoAction) -> Unit) = Column(
...
@Composable
private fun InfoButtonsGrid(onAction: (InfoAction) -> Unit) = Column(
  modifier = Modifier.fillMaxWidth(),
  horizontalAlignment = Alignment.CenterHorizontally,
...
@Composable
private fun InfoButtonsRow(onAction: (InfoAction) -> Unit) = Row(
  modifier = Modifier.fillMaxWidth(),
  horizontalArrangement = Arrangement.spacedBy(HORIZONTAL_SPACING),
) {
  SourceCodeButton(onAction, Modifier.weight(1f))
