...
sealed interface LoginResponse {
  @Serializable data class Success(@SerialName("data") val data: Data) : LoginResponse

  @Serializable data class Failure(@SerialName("reason") val reason: FailureReason) : LoginResponse
