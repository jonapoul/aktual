  ...
  Box(
    ...
    Column(
      ...
      Icon(
        ...
        contentDescription = BudgetSyncStrings.syncFailureDesc,
      )

      VerticalSpacer(30.dp)

      Text(
        text = BudgetSyncStrings.syncFailureMessage,
      ...
      Text(
        text = reason ?: BudgetSyncStrings.syncFailureDefaultMessage,
      ...
      val retryText = BudgetSyncStrings.syncFailureRetry
      PrimaryTextButton(
