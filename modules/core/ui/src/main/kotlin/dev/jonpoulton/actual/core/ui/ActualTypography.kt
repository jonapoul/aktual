...
//       displayMedium = ActualFontFamily.textStyle(ActualColors.navy150, FontWeight.W600, fontSize = 25.sp),
//       displaySmall = ActualFontFamily.textStyle(ActualColors.navy150, FontWeight.W500, fontSize = 20.sp),
...
private fun PreviewTypography() = ActualTheme {
  ...
  Surface(modifier = Modifier.size(width, height)) {
    val items = listOf(
      ActualTypography.displayLarge,
      ActualTypography.displayMedium,
      ActualTypography.displaySmall,
      ActualTypography.headlineLarge,
      ActualTypography.headlineMedium,
      ActualTypography.headlineSmall,
      ActualTypography.titleLarge,
      ActualTypography.titleMedium,
      ActualTypography.titleSmall,
      ActualTypography.bodyLarge,
      ActualTypography.bodyMedium,
      ActualTypography.bodySmall,
      ActualTypography.labelLarge,
      ActualTypography.labelMedium,
      ActualTypography.labelSmall,
    )
    LazyColumn {
      items(items) { style ->
        Text(text = "Quick brown fox", style = style)
      }
    }
  }
}
