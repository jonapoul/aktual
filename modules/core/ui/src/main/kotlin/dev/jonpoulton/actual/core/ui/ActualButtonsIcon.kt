...
fun BasicActualIconButton(
  ...
  contentDescription: String,
  onClick: () -> Unit,
  colors: @Composable (scheme: ActualColorScheme, isPressed: Boolean) -> IconButtonColors,
  modifier: Modifier = Modifier,
  size: Dp? = null,
  enabled: Boolean = true,
  shape: Shape = ActualButtonShape,
  ...
  val buttonColors = colors(colorScheme, isPressed)
...
@Stable
@Composable
private fun ActualColorScheme.primary(isPressed: Boolean) = IconButtonDefaults.filledIconButtonColors(
...
@Stable
@Composable
private fun ActualColorScheme.bare(isPressed: Boolean) = IconButtonDefaults.filledIconButtonColors(
