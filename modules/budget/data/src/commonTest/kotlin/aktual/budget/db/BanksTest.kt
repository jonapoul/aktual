...
internal class BanksTest {
  ...
  private val accountA = buildAccount(
    id = AccountId("a"),
    bank = bankA.id,
  )
  private val accountB = buildAccount(
    id = AccountId("b"),
    bank = bankB.id,
  )
  private val accountC = buildAccount(
    id = AccountId("c"),
